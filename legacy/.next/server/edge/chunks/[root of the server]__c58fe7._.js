(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root of the server]__c58fe7._.js", {
...
"[project]/src/app/api/resources/route.ts [app-edge-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const gistContent = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$github$2e$ts__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["getGistContent"])(process.env.RESOURCES_GIST_ID);
...
async function POST(request) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$github$2e$ts__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["updateGist"])(process.env.RESOURCES_GIST_ID, resources, gistContent?.filename || 'resources.json');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newResource);
    } catch (error) {
...
"[project]/.next-internal/server/app/api/resources/route/actions.js [app-edge-rsc] (ecmascript)": (function(__turbopack_context__) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c58fe7._.js.map